...
export class ReviewService {
    ...
    createReview = async (userId, eventId, body) => {
        ...
        if (!completedTransaction) {
            throw new ApiError("You can only review events you have attended (completed transaction required)", 403);
        }
    ...
    updateOrganizerRating = async (organizerId) => {
        const organizer = await this.prisma.organizer.findUnique({
            where: { id: organizerId },
            include: {
                events: {
